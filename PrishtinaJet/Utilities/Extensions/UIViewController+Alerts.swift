...
//  PrishtinaJet
//
//  Created by Blerd Foniqi on 6/18/21.
//
...
class PopUpActionViewController: UIViewController {
    static let identifier = "NotConnectedVC"
    static func showPopup(parentVC: UIViewController)   {
           if let popupViewController = UIStoryboard(name: "NotConnected", bundle: nil).instantiateViewController(withIdentifier: "NotConnectedVC") as? NotConnectedVC {
